...
<html>
    ...
    <body>
        ...
        %>
        <div class="form_header">Payment Voucher (On Account)</div>
        <form id="frmCustomer" name="frmCustomer" method="post" action="${pageContext.request.contextPath}/ActionController/PaymentOnAccountController">
            <div id="frmBody">

                <div class="row" id="extAccount">
                    <label class="lbltxt">Account : </label>

                    <select id="txtAccount" name="txtAccount" required="" >
                        <%
                            if (accounts != null) {
