<%-- 
    Document   : account_summery
    Created on : Jan 2, 2016, 2:49:31 PM
    Author     : kandy
--%>
...
<html>
    ...
    <%
        ...
        request.setAttribute(SessionVariables.URL, "admin/account_summery.jsp?" + SessionVariables.FUNC + "=" + FUNC);
        ...
        if (request.getParameter("txtBranch") != null) {
...
//        }
    ...
    <body>
        ...
        %>
        <div class="form_header">Income & Expencess</div>
        <form id="frmCustomer" name="frmCustomer" method="post" action="${pageContext.request.contextPath}/IncomeExpenceServlet">
            <div id="frmBody">
                <div class="row" style="<%//=style%>">
                    ...
                    <select id="txtBranch" name="txtBranch" class="double">
        ...
        <%if (FUNC.equals(FormAction.GET_LIST)) {
                ArrayList<IncomeExpences> incomeExpenceses = (ArrayList<IncomeExpences>) request.getAttribute("incomeExpenceses");
        %>
        <div id="tbl">
            <table id="tableData" class="table">
                ...
                <tbody>
                    <%
                        ...
                        double drD = 0.00;
                        double crD = 0.00;
                        for (IncomeExpences incomeExpences : incomeExpenceses) {
                            date = incomeExpences.getDate();
                            description = incomeExpences.getDescription();
                            Dr = incomeExpences.getDr();
                            Cr = incomeExpences.getCr();
