 ...
 * @author ROSHAN
 */
@WebServlet(name = "PaymentOnAccountServlet", urlPatterns = {"/PaymentOnAccountServlet"})
public class PaymentOnAccountServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            narrations = NarrationSER.getList(TransactionType.VOUCHER);
            ArrayList<Account> accounts = AccountSER.getAccounts("'L', 'E'");
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("./admin/payment_vou_ag_account.jsp?FUNC=" + FormAction.SAVE);
            dispatcher.include(request, response);
//            response.sendRedirect("${pageContext.request.contextPath}/admin/add_package.jsp?FUNC=" + FormAction.SAVE);
        } catch (IOException ex) {
            CommonLogger.handle(ex, PaymentOnAccountServlet.class.getName(), "processRequest()");
            Logger.getLogger(PaymentOnAccountServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
